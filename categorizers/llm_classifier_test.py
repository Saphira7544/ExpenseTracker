...
if __name__ == "__main__":
    ...
    #category = classify_transaction(example_description)
    #print(f"{example_description} → {category}")
    example_description = "Interactive Brokers LLC;One Pickwick Plaza; US Greenwich 06830 e-banking payment order Reason for payment: U20456445 / Isabel Castelo; Account no. IBAN: CH64 0023 0230 0576 8905 U; Costs: E-Banking domestic; Transaction no. 0174061TO4501327"
    category = classify_transaction(example_description)
    print(f"{example_description} → {category}")